from .db.models import app_db, Release, Artist, Label, Tag, Review, Goal
from sqlalchemy import func, extract
from datetime import datetime, date


VALID_MODELS = [Release, Artist, Label, Tag, Review, Goal]
...
def total_items(item_type: app_db.Model) -> int:
    # TODO: make this into a classmethod of Base
    try:
        results = app_db.session.query(item_type).count()
        if results is None:
           return 0
...
def total_releases():
    # TODO: remove this and use total_items()
