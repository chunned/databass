...
def register_routes(app):
    ...
    def release(release_id):
        ...
        return render_template('release.html', data=release_data)
    ...
    def artist(artist_id):
        ...
        return render_template('artist.html', data=artist_data)

    @app.route('/label/<string:label_id>', methods=['GET'])
    def label(label_id):
        label_data = db.get_item(item_type='label', item_id=label_id)
        return render_template('label.html', data=label_data)
